...
{include file=#headerTsalPath# title='T-SAL農園&nbsp;SNS'}
		...
		<div class="frame_page">
			...
			<div class="frame_groupHome">
				<div style="margin-bottom:10px"><a href="./myDiaryList.php?year={$year}&month={$month}&day={$day}">一覧へ</a></div>
				<h3>{$cYear}<br>「{$title}」</h3>
					...
					<tr>
						<td class="right" colspan="3">
							<form action="./editDiary.php" method="post">
								...
								<input type="hidden" value="edit" name="proc">
								<input type="submit" value="編集する" class="button_m position_createButton_diary">
							</form>
						</td>
					</tr>
				</table>
...
{/if}
				...
				<form action="myDiary.php?diaryId={$diaryId}" method="post">
					<table class="table_createDiary">
						<tr>
						...
						<tr>
							<td colspan="2" class="right">
								{$system}
								<input type="submit" value="投稿" id="reg" class="button_s textColorRed position_createButton_diary">

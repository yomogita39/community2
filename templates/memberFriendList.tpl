...
{include file=#headerTsalPath# title='T-SAL農園&nbsp;SNS'}
		...
		<div class="frame_page">
			...
			<div class="frame_groupHome">
				...
				<h3 class="h3_list_m memberColor">{$userName}&nbsp;さん&nbsp;友達リスト({$html|@count})</h3>
...
{/if}
							<td class="list_td_m">
								<a href="./profile.php?userId={$var.friendId}">
									<img src="{$var.friendImage}" class="image_m" alt="{$var.friendName}画像">
								</a>
								<div class="list_td_userName"><a href="./profile.php?userId={$var.friendId}">{$var.friendName}({$var.friendCnt})</a></div>
							</td>
